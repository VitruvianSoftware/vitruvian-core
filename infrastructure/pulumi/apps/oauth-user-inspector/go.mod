module github.com/VitruvianSoftware/vitruvian-core/infrastructure/pulumi/oauth-user-inspector

go 1.26.2

require (
	github.com/VitruvianSoftware/pulumi-library/go/pkg/cloud_run v0.2.1-0.20260718212957-b0aa3a454016
