...
| `example_floating_project.go` | `example_floating_project.tf` | Floating project + the monorepo's OSS floating project (live-specific addition) |
...
| `SVPCProjectEnabled`, `FloatingProjectEnabled`, `OSSFloatingProjectEnabled`, `PeeringProjectEnabled` | Project-type enablement toggles |
...
| `OSSFloatingProjectID`, `OSSFloatingProjectNumber` | OSS floating project (live-specific addition) |
