# 4-projects / business_unit_1 / production

Thin business-unit leaf for the **production** environment, the Pulumi port of
upstream terraform-example-foundation
[`4-projects/business_unit_1/production`](https://github.com/terraform-google-modules/terraform-example-foundation/tree/master/4-projects/business_unit_1/production).
