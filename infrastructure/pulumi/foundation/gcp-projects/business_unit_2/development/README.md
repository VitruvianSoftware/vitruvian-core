# 4-projects / business_unit_2 / development

Thin business-unit leaf for the **development** environment, the Pulumi port of
upstream terraform-example-foundation
[`4-projects/business_unit_2/development`](https://github.com/terraform-google-modules/terraform-example-foundation/tree/master/4-projects/business_unit_2/development).
The leaf pins the environment identity (`development` / `d`), creates the BU
...
| `Pulumi.production.yaml` | `*.auto.tfvars` | Committed stack configuration (live) |

## Inputs

| Name | Description | Default | Required |
|------|-------------|---------|:--------:|
| `business_code` | The business code (ex. `bu2`) | n/a | yes |
| `billing_account` | The ID of the billing account to associate projects with | n/a | yes |
| `org_stack_name` | StackReference to the 1-org stack | `ipv1337/foundation-org-shared/production` | no |
| `env_stack_name` | StackReference to this env's 2-environments leaf stack | `ipv1337/foundation-environments-{env}/production` | no |
| `network_stack_name` | StackReference to this env's 3-networks leaf stack | `ipv1337/foundation-networks-{env}/production` | no |
...
| `oss_floating_project_enabled` | Deploy the monorepo's OSS floating project (live-specific addition) | `false` | no |
...
| `oss_floating_project` | OSS floating project id (live-specific addition) |
| `oss_floating_project_number` | OSS floating project number (live-specific addition) |
