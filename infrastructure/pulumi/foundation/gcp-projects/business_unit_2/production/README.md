# 4-projects / business_unit_2 / production

Thin business-unit leaf for the **production** environment, the Pulumi port of
upstream terraform-example-foundation
[`4-projects/business_unit_2/production`](https://github.com/terraform-google-modules/terraform-example-foundation/tree/master/4-projects/business_unit_2/production).
The leaf pins the environment identity (`production` / `p`), creates the BU
