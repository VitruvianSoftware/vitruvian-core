...
```sh
bazel run //infrastructure/pulumi/foundation/gcp-environments/envs/development:preview
bazel run //infrastructure/pulumi/foundation/gcp-environments/envs/development:up
```
