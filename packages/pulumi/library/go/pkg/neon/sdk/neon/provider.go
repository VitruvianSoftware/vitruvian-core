...
// The provider type for the neon package. By default, resources use package-wide configuration
...
func NewProvider(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("pulumi:providers:neon", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (r *Provider) TerraformConfig(ctx *pulumi.Context) (pulumi.MapOutput, error) {
	...
	out, err := ctx.CallPackage("pulumi:providers:neon/terraformConfig", nil, providerTerraformConfigResultOutput{}, r, ref)
	if err != nil {
		return pulumi.MapOutput{}, err
	}
