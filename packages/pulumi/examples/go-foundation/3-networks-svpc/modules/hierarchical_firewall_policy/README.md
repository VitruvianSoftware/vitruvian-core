...
[`3-networks-svpc/modules/hierarchical_firewall_policy`](https://github.com/terraform-google-modules/terraform-example-foundation/tree/master/3-networks-svpc/modules/hierarchical_firewall_policy)
— the org/folder-level hierarchical firewall policy and its folder
associations (envs/shared only).
