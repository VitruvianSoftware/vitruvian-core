# 3-networks-svpc / envs / nonproduction

Pulumi (Go) port of upstream terraform-example-foundation
[`3-networks-svpc/envs/nonproduction`](https://github.com/terraform-google-modules/terraform-example-foundation/tree/master/3-networks-svpc/envs/nonproduction)
— the nonproduction root of the networks stage. It pins the environment
identity (`nonproduction`/`n`) and calls the shared `modules/base_env`
