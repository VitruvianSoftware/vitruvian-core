...
// Foundation stage 3 (networks, svpc) — thin env root for the production
// environment, mirroring upstream terraform-example-foundation
// 3-networks-svpc/envs/production. This leaf pins the environment identity
// (production/p) and calls the shared base_env module; all resource creation
...
// 3-networks-svpc/envs/production hardcodes env = "production" in its
