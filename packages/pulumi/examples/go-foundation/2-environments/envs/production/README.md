...
```sh
bazel run //pulumi/examples/go-foundation/2-environments/envs/production:preview
bazel run //pulumi/examples/go-foundation/2-environments/envs/production:up
```
