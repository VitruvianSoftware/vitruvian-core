...
Thin environment leaf for `business_unit_1` in the **development** environment,
mirroring upstream
`terraform-example-foundation/5-app-infra/business_unit_1/development`.

The environment identity (`development` / `d`) is **pinned in `main.go`**
