...
4. **The monorepo imports your PR automatically** (within ~15 min — a scheduled job), opening a PR in `vitruvian-core` under `apps/mcp/slack/` **with you as the author**, where the full monorepo CI + review run.
