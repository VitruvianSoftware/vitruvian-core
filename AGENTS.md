...
>   `apps/web/oauth-user-inspector/`, `apps/mobile/android-remote/`, `apps/desktop/home-speaker/`,
>   `apps/embedded/esp32-s3/`) — put per-component detail there, not here. Note that an
