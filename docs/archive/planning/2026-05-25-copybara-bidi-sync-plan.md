...
The pilot ran live against `main` on both repos. **Result: bidirectional no-bounce sync works; fail-loud conflict handling does not.** Operator runbook: [`docs/copybara-sync.md`](../../admin/copybara-sync.md).
