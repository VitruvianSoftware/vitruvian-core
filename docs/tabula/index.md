...
- **[Product Analysis](product/analysis.md)** - Competitive analysis of similar products (Workona)
  including pricing tiers, features, and market positioning
- **[Roadmap](product/roadmap.md)** - Product development roadmap with planned phases and features
- **[User Stories](product/user-stories.md)** - Detailed user stories for all roadmap phases with
  acceptance criteria
...
- **[../api/openapi.yaml](../api/openapi.yaml)** - OpenAPI 3.0 specification with complete API
  contract for all endpoints

## Quick Links

- [Main README](../README.md) - Project overview and quick start
- [Contributing Guidelines](../CONTRIBUTING.md) - How to contribute to Tabula
...
1. Start with the [main README](../README.md) to understand what Tabula is
2. Review the [Product Analysis](product/analysis.md) to understand our competitive landscape
3. Check the [Roadmap](product/roadmap.md) to see where we're headed
4. Read [User Stories](product/user-stories.md) for detailed feature requirements
...
8. Explore the [OpenAPI spec](../api/openapi.yaml) for API details
9. Review [infrastructure documentation](../infrastructure/README.md) for deployment information
...
3. Check [SPECS.md](./SPECS.md) for implementation details
4. Follow the [NFR.md](./NFR.md) requirements for performance and quality
5. Reference [USER_STORIES.md](./USER_STORIES.md) when implementing features
6. Use the [OpenAPI spec](../api/openapi.yaml) as the API contract

## For Product Managers

If you're planning features or managing the roadmap:

1. Review [ROADMAP.md](./ROADMAP.md) for the current product plan
2. Check [USER_STORIES.md](./USER_STORIES.md) for detailed requirements
3. Reference [PRODUCT_ANALYSIS.md](./PRODUCT_ANALYSIS.md) for competitive context
4. Use GitHub issue templates in [../.github/ISSUE_TEMPLATE](../.github/ISSUE_TEMPLATE) for new
   features

## Contributing to Documentation

Documentation improvements are always welcome! Please see our
[Contributing Guidelines](../CONTRIBUTING.md) for more information on how to submit documentation
updates.
