...
out="$(bash "$SCRIPT" --app "tabula-api" --pr 142 --dry-run)"
...
out="$(bash "$SCRIPT" --app "tabula-api" --pr 142 --neon-project-id "neon-prj-123" --dry-run)"
...
out="$(bash "$SCRIPT" --app "tabula-api" --pr 142 --mode k8s --dry-run)"
