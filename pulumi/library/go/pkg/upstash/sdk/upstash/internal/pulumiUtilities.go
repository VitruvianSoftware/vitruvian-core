...
func PkgVersion() (semver.Version, error) {
	...
	re := regexp.MustCompile("^github.com/VitruvianSoftware/pulumi-library/go/pkg/upstash/sdk/upstash(/v\\d+)?")
...
func PkgGetPackageRef(ctx *pulumi.Context) (string, error) {
	if packageRef == nil {
		...
		parameter, err := base64.StdEncoding.DecodeString("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL3Vwc3Rhc2gvdXBzdGFzaCIsInZlcnNpb24iOiIyLjEuMCJ9fQ==")
		if err != nil {
			return "", err
		}
