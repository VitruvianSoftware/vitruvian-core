...
func PkgVersion() (semver.Version, error) {
	...
	re := regexp.MustCompile("^github.com/VitruvianSoftware/pulumi-library/go/pkg/neon/sdk/neon(/v\\d+)?")
...
func PkgGetPackageRef(ctx *pulumi.Context) (string, error) {
	if packageRef == nil {
		...
		parameter, err := base64.StdEncoding.DecodeString("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2tpc2xlcmRtL25lb24iLCJ2ZXJzaW9uIjoiMC4xNC4wIn19")
		if err != nil {
			return "", err
		}
