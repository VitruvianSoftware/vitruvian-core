...
// Foundation stage 3 (networks, svpc) — thin env root for the development
// environment, mirroring upstream terraform-example-foundation
// 3-networks-svpc/envs/development. This leaf pins the environment identity
// (development/d) and calls the shared base_env module; all resource creation
...
// 3-networks-svpc/envs/development hardcodes env = "development" in its
