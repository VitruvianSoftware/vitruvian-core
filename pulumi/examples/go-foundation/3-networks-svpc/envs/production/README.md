# 3-networks-svpc / envs / production

Pulumi (Go) port of upstream terraform-example-foundation
[`3-networks-svpc/envs/production`](https://github.com/terraform-google-modules/terraform-example-foundation/tree/master/3-networks-svpc/envs/production)
— the production root of the networks stage. It pins the environment
identity (`production`/`p`) and calls the shared `modules/base_env`
