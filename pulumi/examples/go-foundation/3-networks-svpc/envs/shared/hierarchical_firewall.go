...
// firewall policy, mirroring upstream
// 3-networks-svpc/envs/shared/hierarchical_firewall.tf.
func deployHierarchicalFirewall(ctx *pulumi.Context, cfg *SharedConfig) error {
