 ...
 */
export declare type EnforcementLevel = "advisory" | "mandatory" | "remediate" | "disabled";
/**
 * Indicates the severity of a policy.
 */
export declare type Severity = "low" | "medium" | "high" | "critical";
/**
 * Represents configuration for the policy pack.
 */
export declare type PolicyPackConfig = {
    [policy: string]: PolicyConfig;
};
declare type PolicyConfig = EnforcementLevel | ({
    enforcementLevel?: EnforcementLevel;
} & {
    [key: string]: any;
});
 ...
 */
export declare type Policies = (ResourceValidationPolicy | StackValidationPolicy)[];
export declare type ResourceRemediation = (args: ResourceValidationArgs) => Promise<Record<string, any>> | Record<string, any> | Promise<void> | void | undefined;
/**
 ...
 */
export declare type ResourceValidation = (args: ResourceValidationArgs, reportViolation: ReportViolation) => Promise<void> | void;
/**
...
export interface ResourceValidationArgs {
     ...
     * ```
     */
    isType<TResource extends Resource>(resourceClass: {
     ...
     * ```
     */
    asType<TResource extends Resource, TArgs>(resourceClass: {
 ...
 */
export declare type TypedResourceRemediation<TProps> = (props: TProps, args: ResourceValidationArgs) => Promise<Record<string, any>> | Record<string, any> | Promise<void> | void | undefined;
/**
 ...
 */
export declare function remediateResourceOfType<TResource extends Resource, TArgs>(resourceClass: {
    new (name: string, args: TArgs, ...rest: any[]): TResource;
}, remediate: TypedResourceRemediation<Unwrap<NonNullable<TArgs>>>): ResourceRemediation;
/**
 ...
 */
export declare type TypedResourceValidation<TProps> = (props: TProps, args: ResourceValidationArgs, reportViolation: ReportViolation) => Promise<void> | void;
/**
 ...
 */
export declare function validateResourceOfType<TResource extends Resource, TArgs>(resourceClass: {
    new (name: string, args: TArgs, ...rest: any[]): TResource;
}, validate: TypedResourceValidation<Unwrap<NonNullable<TArgs>>>): ResourceValidation;
/**
 ...
 */
export declare type TypedResourceValidationRemediation<TProps> = (props: TProps, args: ResourceValidationArgs, reportViolation: ReportViolation) => Promise<Record<string, any>> | Record<string, any> | Promise<void> | void | undefined;
/**
 ...
 * ```
 */
export declare function validateRemediateResourceOfType<TResource extends Resource, TArgs>(resourceClass: {
    new (name: string, args: TArgs, ...rest: any[]): TResource;
 ...
 */
export declare type StackValidation = (args: StackValidationArgs, reportViolation: ReportViolation) => Promise<void> | void;
/**
...
export interface PolicyResource {
     ...
     * ```
     */
    asType<TResource extends Resource>(resourceClass: {
        new (...rest: any[]): TResource;
 ...
 */
export declare function validateStackResourcesOfType<TResource extends Resource>(resourceClass: {
    new (...rest: any[]): TResource;
 ...
 */
export declare type ReportViolation = {
