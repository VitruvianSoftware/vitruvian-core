...
exports.unknownObjectValue = exports.unknownArchiveValue = exports.unknownAssetValue = exports.unknownArrayValue = exports.unknownStringValue = exports.unknownNumberValue = exports.unknownBooleanValue = exports.UnknownValueError = exports.getSpecialProxyTarget = exports.isSpecialProxy = exports.unknownCheckingProxy = void 0;
/**
 ...
 * @internal
 */
function unknownCheckingProxy(toProxy) {
    return proxyHelper(toProxy, []);
}
exports.unknownCheckingProxy = unknownCheckingProxy;
/**
 * isSpecialProxy can be used to detect the presence of a special proxy.
 * @internal
 */
exports.isSpecialProxy = "__isSpecialProxy";
/**
 * getSpecialProxyTarget can be used to return the original underlying proxied object.
 * @internal
 */
exports.getSpecialProxyTarget = "__getSpecialProxyTarget";
/**
 ...
 * @internal
 */
function proxyHelper(toProxy, propsAcc) {
    if (!(toProxy instanceof Object)) {
        return toProxy;
    }
    return new Proxy(toProxy, {
        get: (obj, prop) => {
            if (prop === exports.isSpecialProxy) {
                return true;
            }
            else if (prop === exports.getSpecialProxyTarget) {
                return obj;
            }
            const newProps = propsAcc.concat([prop]);
            const field = obj[prop];
            if (isUnknown(field)) {
                throw new UnknownValueError(field, newProps);
            }
...
class UnknownValueError extends Error {
    constructor(unknownTypeSentinel, props) {
...
exports.UnknownValueError = UnknownValueError;
function isUnknown(o) {
    return (o === exports.unknownBooleanValue ||
        o === exports.unknownNumberValue ||
        o === exports.unknownStringValue ||
        o === exports.unknownArrayValue ||
        o === exports.unknownAssetValue ||
        o === exports.unknownArchiveValue ||
        o === exports.unknownObjectValue);
}
function unknownToString(o) {
    switch (o) {
        case exports.unknownBooleanValue:
            return "boolean";
        case exports.unknownNumberValue:
            return "number";
        case exports.unknownStringValue:
            return "string";
        case exports.unknownArrayValue:
            return "Array";
        case exports.unknownAssetValue:
            return "asset";
        case exports.unknownArchiveValue:
            return "archive";
        case exports.unknownObjectValue:
            return "Object";
        default:
...
/** @internal */
exports.unknownBooleanValue = "1c4a061d-8072-4f0a-a4cb-0ff528b18fe7";
