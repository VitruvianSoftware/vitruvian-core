# 5-app-infra: business_unit_1/nonproduction

Thin environment leaf for `business_unit_1` in the **nonproduction** environment,
mirroring upstream
`terraform-example-foundation/5-app-infra/business_unit_1/nonproduction`.

The environment identity (`nonproduction` / `n`) is **pinned in `main.go`**
