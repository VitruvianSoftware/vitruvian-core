...
```sh
bazel run //pulumi/examples/go-foundation/2-environments/envs/nonproduction:preview
bazel run //pulumi/examples/go-foundation/2-environments/envs/nonproduction:up
```
