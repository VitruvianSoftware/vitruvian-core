module foundation-1-org

go 1.26.2

require (
	foundation-1-org/modules v0.0.0-00010101000000-000000000000
	github.com/VitruvianSoftware/pulumi-library/go/pkg/org_policy v0.0.0-00010101000000-000000000000
...
require (
	...
	github.com/VitruvianSoftware/pulumi-library/go/pkg/cai_monitoring v0.0.0-00010101000000-000000000000 // indirect
